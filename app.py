...
def save_score():
    ...
    #verifying existence
    if name is None or score is None or cause is None or duration is None or speed is None or gameMode is None:
    ...
    line = f"[{timestamp}] {name} | {gameMode} | {score} | {speed} | {cause} | {duration}\n"
